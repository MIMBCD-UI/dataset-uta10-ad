...
[![License: AGPL v3](https://img.shields.io/badge/License-AGPL%20v3-blue.svg?style=flat-square)](https://github.com/MIMBCD-UI/dataset-uta10-ad/blob/master/LICENSE)
[![Last commit](https://img.shields.io/github/last-commit/MIMBCD-UI/dataset-uta10-ad?style=flat-square)](https://github.com/MIMBCD-UI/dataset-uta10-ad/commits/master)
...
Several *datasets* are fostering innovation in higher-level functions for everyone, everywhere. By providing this repository, we hope to encourage the research community to focus on hard problems. In this repository, we present a full sampling of our affinity diagrams extrated from the focus groups during the [User Tests and Analysis 10 (UTA10)](https://github.com/MIMBCD-UI/meta/wiki/User-Research#user-test-evaluations-) study. Here, we provide a [`dataset/`](dataset/) of the extrated [affinity diagrams](https://en.wikipedia.org/wiki/Affinity_diagram) during the [focus groups](https://en.wikipedia.org/wiki/Focus_group) for the [UTA10](https://github.com/MIMBCD-UI/meta/wiki/User-Research#user-test-evaluations-) tasks. The user tests were made in clinical institutions, where clinicians diagnose several patients for a **Bounding Boxes** *vs* **Real Lesion Contours** comparison. For example, in these tests, we used the [`prototype-lesion-bbs`](https://github.com/MIMBCD-UI/prototype-lesion-bbs) and [`prototype-rlc`](https://github.com/MIMBCD-UI/prototype-rlc) repositories for the comparison. On the same hand, the hereby *dataset* represents the pieces of information of both [BreastScreening](https://BreastScreening.github.io) and [MIDA](https://mida-project.github.io) research works. For more information about the available *datasets* please follow the [Datasets](https://github.com/MIMBCD-UI/meta/wiki/Datasets) page on the [Wiki](https://github.com/MIMBCD-UI/meta/wiki) of the [`meta`](https://github.com/MIMBCD-UI/meta) information repository. Last but not least, you can find further information on the [Wiki](https://github.com/MIMBCD-UI/dataset-uta7-ad/wiki) in this repository. We also have several demos to see in our [YouTube Channel](https://www.youtube.com/channel/UCPz4aTIVHekHXTxHTUOLmXw), please follow us.
...
```bash
git clone https://github.com/MIMBCD-UI/dataset-uta10-ad.git
```
...
Either as something that seems missing or any need for support, just open a [new issue](https://github.com/MIMBCD-UI/dataset-uta10-ad/issues/new). Regardless of being a simple request or a fully-structured feature, we will do our best to understand them and, eventually, solve them.
